...
export default function Attendance() {
  ...
  const handleApply = () => {
    ...
    // yaha se API call kar sakta hai
  };
  return (
    <div className="flex min-h-screen bg-slate-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="col-span-1 bg-white rounded-2xl shadow p-6 flex flex-col items-center justify-between gap-8 border border-gray-100">
              ...
              <div className="flex flex-col gap-3 w-full">
                ...
                <button className="bg-teal-500 hover:bg-teal-600 text-white font-semibold px-6 py-3 rounded-lg shadow transition">
                  Check Out
                </button>
                <button className="border border-slate-200 text-slate-500 font-semibold px-6 py-2 rounded-lg transition hover:bg-slate-100">
                  Request Break
                </button>
              </div>
            </div>
      ...
      >
        Apply
              ...
              <option value=""></option>
              <span className="text-indigo-600 font-semibold text-sm cursor-pointer">
                Download Report
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl shadow p-6 flex flex-col border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <button className="w-6 h-6 rounded-full bg-slate-100 flex items-center justify-center">
                    {"<"}
                  </button>
                  <button className="w-6 h-6 rounded-full bg-slate-100 flex items-center justify-center">
                    {">"}
              ...
              <div className="grid grid-cols-7 gap-2 text-center text-xs">
                ...
                <div className="bg-indigo-700 text-white rounded-full shadow">
                  24
                </div>
                <div>25</div>
                <div>26</div>
            ...
            <div className="bg-linear-to-b from-indigo-100 to-white rounded-2xl p-6 border-none">
              <h4 className="text-teal-500 font-semibold text-sm mb-2">
                Company Policy
              </h4>
